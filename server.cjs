...
const clientId = process.env.WCL_CLIENT_ID || 'a13081ff-037a-4d7d-8857-0cedb82e729f';
const clientSecret = process.env.WCL_CLIENT_SECRET || 'TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT';
